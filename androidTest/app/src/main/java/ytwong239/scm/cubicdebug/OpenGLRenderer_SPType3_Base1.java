...
public class OpenGLRenderer_SPType3_Base1 implements GLSurfaceView.Renderer {
    ...
    QuestionBank_SPType3_Base1 questionBank_spType3_base1 = new QuestionBank_SPType3_Base1();
    private static boolean canDraw = false;

    public OpenGLRenderer_SPType3_Base1(){
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if(canDraw){
            ...
            for(int i = 0; i < MAXGRIDSNUM; i++){
                for(int j = 0; j < MAXHEIGHTNUM; j++){
                    if(questionBank_spType3_base1.getIsCubePresent(i, j)){
