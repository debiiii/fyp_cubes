...
public class Cube_Red {
    ...
    private float[][] red = {  // Colors of the 6 faces
            {221/255f, 61/255f, 61/255f, 1.0f},  // 0. dark. back
            {236/255f, 145/255f, 145/255f, 1.0f},  // 1. light. bottom
            {224/255f, 78/255f, 78/255f, 1.0f},  // 2. middle. right
            {236/255f, 145/255f, 145/255f, 1.0f},  // 3. light. top
            {224/255f, 78/255f, 78/255f, 1.0f},  // 4. middle. left
            {221/255f, 61/255f, 61/255f, 1.0f} ,  // 5. dark. front
            {1f, 1f, 1f, 1f} // white
    };
    ...
    public void draw(float[] mvpMatrix) {
        ...
        for (int face = 0; face < numFaces; face++) {
            ...
            GLES20.glUniform4fv(colorHandle, 1, red[face], 0);
    ...
    public void drawFront(float[] mvpMatrix){
        ...
        GLES20.glUniform4fv(colorHandle, 1, red[6], 0);
        //front = 5
