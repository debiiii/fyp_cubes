...
/**
 * Created by DebbieWong on 4/4/2019.
 */

public class OpenGLRenderer_DetectionCheck implements GLSurfaceView.Renderer {
    ...
    private static Boolean[][] isCubePressent = new Boolean[MAXGRIDSNUM][MAXHEIGHTNUM];

    Arduino arduino = new Arduino();

    public OpenGLRenderer_DetectionCheck(){
    ...
    public static void setIsCubePressentTrue(int grid, int height){
        isCubePressent[grid][height] = true;
    }

    public static void setIsCubePressentFalse(int grid, int height){
        isCubePressent[grid][height] = false;
    }
