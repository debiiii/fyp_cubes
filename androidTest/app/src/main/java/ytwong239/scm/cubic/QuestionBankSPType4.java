...
public class QuestionBankSPType4 {

    private static final int MAXQUESTBANKSPTYPE4SUM = 2;
    private QuestionSPType4 questionSPType4s[] = new QuestionSPType4[MAXQUESTBANKSPTYPE4SUM];
    
    private static int currQuestBankSPType4Num;
    
    public QuestionBankSPType4(){
        
        for(int i = 0; i < MAXQUESTBANKSPTYPE4SUM; i++){
            questionSPType4s[i] = new QuestionSPType4();
        }
