...
public class QuestionBank_SPType4_Ans {
    ...
    public QuestionBank_SPType4_Ans(){
        ...
        questionSPType4s[2].setQuestionVal(0, 0);
        questionSPType4s[2].setQuestionVal(0, 1);
        questionSPType4s[2].setQuestionVal(1, 0);
        questionSPType4s[2].setQuestionVal(1, 1);
        questionSPType4s[2].setQuestionVal(2, 0);
        questionSPType4s[2].setQuestionVal(4, 0);
        questionSPType4s[2].setQuestionVal(7, 0);

        questionSPType4s[3].setQuestionVal(0, 0);
        questionSPType4s[3].setQuestionVal(0, 1);
        questionSPType4s[3].setQuestionVal(1, 1);
        questionSPType4s[3].setQuestionVal(2, 1);
        questionSPType4s[3].setQuestionVal(3, 0);
        questionSPType4s[3].setQuestionVal(5, 1);
        questionSPType4s[3].setQuestionVal(6, 0);
        questionSPType4s[3].setQuestionVal(8, 0);
        questionSPType4s[3].setQuestionVal(8, 1);
        questionSPType4s[3].setQuestionVal(8, 2);

        questionSPType4s[4].setQuestionVal(2,0);
        questionSPType4s[4].setQuestionVal(2,1);
        questionSPType4s[4].setQuestionVal(2,2);
        questionSPType4s[4].setQuestionVal(4,0);
        questionSPType4s[4].setQuestionVal(4,1);
        questionSPType4s[4].setQuestionVal(5,0);
        questionSPType4s[4].setQuestionVal(6,0);
        questionSPType4s[4].setQuestionVal(8,0);

        questionSPType4s[5].setQuestionVal(2,0);
        questionSPType4s[5].setQuestionVal(3,0);
        questionSPType4s[5].setQuestionVal(3,1);
        questionSPType4s[5].setQuestionVal(3,2);
        questionSPType4s[5].setQuestionVal(4,2);
        questionSPType4s[5].setQuestionVal(5,2);
        questionSPType4s[5].setQuestionVal(6,0);
