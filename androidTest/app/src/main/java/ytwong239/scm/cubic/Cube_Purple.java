...
public class Cube_Purple {
    ...
    private float[][] purple = {  // Colors of the 6 faces
            {143/255f, 71/255f, 181/255f, 1.0f},  // 0. dark. back
            {186/255f, 140/255f, 210/255f, 1.0f},  // 1. light. bottom
            {152/255f, 84/255f, 188/255f, 1.0f},  // 2. middle. right
            {186/255f, 140/255f, 210/255f, 1.0f},  // 3. light. top
            {152/255f, 84/255f, 188/255f, 1.0f},  // 4. middle. left
            {143/255f, 71/255f, 181/255f, 1.0f} ,  // 5. dark. front
            {1f, 1f, 1f, 1f} // white
    };
    ...
    public void draw(float[] mvpMatrix) {
        ...
        for (int face = 0; face < numFaces; face++) {
            ...
            GLES20.glUniform4fv(colorHandle, 1, purple[face], 0);
    ...
    public void drawFront(float[] mvpMatrix){
        ...
        GLES20.glUniform4fv(colorHandle, 1, purple[6], 0);
        //front = 5
